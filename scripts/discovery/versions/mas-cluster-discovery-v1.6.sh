...
# IBM MAS / OpenShift Cluster Discovery & Assessment v1.6
...
cat <<'EOF'
Usage:
  ./mas-cluster-discovery-v1.6.sh [options]
...
# V1.6 - all MAS application namespaces and current isolation mapping.
...
# V1.6 - optional AppConfig/Graphite
...
echo '</main><footer>IBM MAS / OpenShift Cluster Discovery v1.6 — Read-only assessment</footer></body></html>'
} >"$HTML_REPORT"
