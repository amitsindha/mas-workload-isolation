...
# IBM MAS / OpenShift Cluster Discovery & Assessment v1.7
...
cat <<'EOF'
Usage:
  ./mas-cluster-discovery-v1.7.sh [options]
...
echo '</main><footer>IBM MAS / OpenShift Cluster Discovery v1.7 — Read-only assessment</footer></body></html>'
} >"$HTML_REPORT"
