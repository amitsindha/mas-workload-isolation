#!/usr/bin/env bash
# MAS Workload Isolation Orchestrator V4.1.1
...
usage(){ cat <<'EOF'
Usage:
 ./mas-workload-isolation-V4.1.1.sh --components mas|sls|mongodb|db2|comma-separated combination --instance eam2 --core-namespace mas-eam2-core \
...
db2_precheck(){
  ...
  info "V4.1.1 DB2 scope: IBM MAS Manage DB2U only; Monitor/Predict excluded."
