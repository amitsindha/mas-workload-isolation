#!/usr/bin/env bash
# MAS Workload Isolation Orchestrator V4.3.1
...
usage(){ cat <<'EOF'
Usage:
 ./mas-workload-isolation-V4.3.1.sh --components mas|sls|mongodb|db2|facilities|comma-separated combination --instance eam2 --core-namespace mas-eam2-core \
