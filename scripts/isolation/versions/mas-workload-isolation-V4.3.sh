#!/usr/bin/env bash
# MAS Workload Isolation Orchestrator V4.3
...
usage(){ cat <<'EOF'
Usage:
 ./mas-workload-isolation-V4.3.sh --components mas|sls|mongodb|db2|facilities|comma-separated combination --instance eam2 --core-namespace mas-eam2-core \
